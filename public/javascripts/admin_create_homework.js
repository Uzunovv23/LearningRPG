(function () {
  ...
  function initFileInput(wrapper) {
    ...
    function updateDropLabel() {
      ...
      if (count === 0) {
        label.innerHTML =
          "<strong>Кликни за избор</strong> или провлачи файловете тук";
      } else {
        label.innerHTML =
          "<strong>" +
          count +
          " " +
          (count === 1 ? "файл избран" : "файла избрани") +
          "</strong>" +
          " &mdash; кликни за добавяне на още";
      }
    }
  ...
  var DAYS_SHORT = ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Нд"];
  ...
  function initDatetimePicker(wrapper) {
    ...
    var chevron = trigger.querySelector(".dt-chevron");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var form = document.querySelector('form[action="/admin/homework/create"]');
    if (form) {
      ...
      function validateDates() {
        var startVal = form.querySelector('input[name="startDate"]').value;
        var endVal = form.querySelector('input[name="endDate"]').value;
